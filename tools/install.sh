...
#   sh -c "$(curl -fsSL https://raw.githubusercontent.com/shirey25/ohmyzsh/master/tools/install.sh)"
# or via wget:
#   sh -c "$(wget -qO- https://raw.githubusercontent.com/shirey25/ohmyzsh/master/tools/install.sh)"
# or via fetch:
#   sh -c "$(fetch -o - https://raw.githubusercontent.com/shirey25/ohmyzsh/master/tools/install.sh)"
#
...
# or:
#   sh -c "$(curl -fsSL https://raw.githubusercontent.com/shirey25/ohmyzsh/master/tools/install.sh" "" --unattended
#
set -e
